...
function Linking() {
    ...
    return (
        <div className='relative'>
            ...
            <div className='flex md:flex-row flex-col items-center h-screen w-screen max-w-7xl absolute top-0 left-0 z-30'>
                    <div className='w-1/2 flex justify-center items-center'>
                    <img className='z-30 rounded-full md:h-96 md:w-96 h-48 w-48 mb-3 mt-10' src="/images/Shubh.png" alt="" />
                    </div>
                    <div className='flex flex-col justify-center items-center w-1/2'>
                    <p className='text-white md:text-[32px] text-[24px] font-medium text-center md:mb-8 mb-10 gap-3 font-["Poppins"]'>
                        Hey There!👋🏽
