...
function TechStack() {
    ...
    <div className="px-10 py-24 mx-auto max-w-8xl">
        ...
        <div className="grid grid-cols-4 gap-10 mb-3 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
            ...
            <div className="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl hover:scale-[102%] cursor-pointer hover:bg-gray-200 active:scale-95 rounded-md" data-rounded="rounded-xl" data-rounded-max="rounded-full">
            ...
            <div className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl hover:scale-[102%] cursor-pointer hover:bg-gray-200 active:scale-95 rounded-md" data-rounded="rounded-xl" data-rounded-max="rounded-full">
                <div className="p-3 text-white bg-black rounded-full" data-primary="blue-500" data-rounded="rounded-full">
