...
function TechStack() {
    ...
    <div class="px-10 py-24 mx-auto max-w-8xl">
        <div class="w-full mx-auto text-left md:text-center">
            <h1 class="mb-4 text-5xl font-extrabold leading-none max-w-5xl mx-auto tracking-normal text-white sm:text-6xl md:text-6xl lg:text-7xl md:tracking-tight"> My <span class="w-full text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 lg:inline">technology stack</span> that<br class="lg:block hidden" />is all that a design needs. </h1>
            <p class="px-0 mb-6 text-lg text-gray-200 md:text-xl lg:px-24"> Being a front-end developer, I'll use my techstack to help tell your story through websites! </p>
        </div>
    </div>
</section>
        <div class="grid grid-cols-4 gap-10 mb-3 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">

            <div class="relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 sm:rounded-xl hover:scale-[102%] cursor-pointer hover:bg-gray-200 active:scale-95 rounded-md" data-rounded="rounded-xl" data-rounded-max="rounded-full">
            ...
            <div class="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-gray-100 sm:rounded-xl hover:scale-[102%] cursor-pointer hover:bg-gray-200 active:scale-95 rounded-md" data-rounded="rounded-xl" data-rounded-max="rounded-full">
                <div class="p-3 text-white bg-black rounded-full" data-primary="blue-500" data-rounded="rounded-full">
